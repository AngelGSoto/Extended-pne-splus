...
if __name__ == "__main__":
    ...
    plt.imshow(gaussian_filter(halpha, 1), vmin=2.e3, vmax=3.e3, interpolation = 'nearest', origin='lower', cmap='gray', norm=LogNorm(), alpha=0.75)
    ...
    plt.imshow(gaussian_filter(halpha_clip, 0.1),  vmin=2.e3, vmax=3.e3, interpolation = 'nearest', origin='lower', cmap=plt.cm.get_cmap('gray'), norm=LogNorm(), alpha=0.85)
    ...
    img1.add_scalebar(1.0/60.)
    img1.scalebar.set_label('1 arcmin')
    ...
    plt.savefig("halpha-{}_{}.pdf".format(cmd_args.field, 
                                          cmd_args.source))
